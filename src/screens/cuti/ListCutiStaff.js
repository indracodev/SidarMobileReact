      ...
      axios({
        ...
        .then(responseprofile => {
          ...
          axios({
            ...
            url: `${baseUrl}/api/sidar_izin_cuti/all`,
            headers: {
              'X-Api-Key': '0ED40DE05125623C8753B6D3196C18DE',
            ...
            .then(response => {
              this.setState({dar: response.data.data.sidar_izin_cuti});
              this.setState({
                filteredDataSource: response.data.data.sidar_izin_cuti,
              });
              this.setState({
                masterDataSource: response.data.data.sidar_izin_cuti,
              });
            ...
            <HeaderRNE
              ...
              rightComponent={
                <View style={styles.headerRight}>
                  <TouchableOpacity
                    onPress={() =>
                      this.props.navigation.navigate('DrawerAddCuti', {
                  ...
                  <View style={{flexDirection: 'row'}}>
                    <View style={{flex: 1}}>
                      <Text
                        ...
                        Jumlah Cuti {item.jumlahcutihari} Hari {'\n'}Tanggal :{' '}
                        {item.cutipadatanggal}
                      </Text>
                    </View>
                    <View>
